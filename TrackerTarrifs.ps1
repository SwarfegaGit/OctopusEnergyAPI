...
foreach ($DNO in '_A', '_B', '_C', '_D', '_E', '_F', '_G', '_H', '_J', '_K', '_L', '_M', '_N', '_P') {
    ...
    [PSCustomObject]@{
        ...
        electricity_standard_unit_rate_inc_vat = $ETarrif.standard_unit_rate_inc_vat
        electricity_standing_charge_inc_vat = $ETarrif.standing_charge_inc_vat
        gas_standard_unit_rate_inc_vat = $GTarrif.standard_unit_rate_inc_vat
        gas_standing_charge_inc_vat = $GTarrif.standing_charge_inc_vat
    }
}
